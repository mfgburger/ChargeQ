...
def random_car_list(length=5):
    ...
    consumptions = [
                       0.2] * length  # kW/km #todo https://www.virta.global/blog/ev-charging-101-how-much-electricity-does-an-electric-car-use
...
def optimize(list_of_cars, algorithm_name="classical"):
    if algorithm_name == "classical":
        ...
        classical(list_of_cars)
    else:
        quantum(list_of_cars)
    # calculate times
    # return loss
...
def classical(list_of_cars):
    return sorted(list_of_cars, key=lambda car: car._state_of_charge)  # todo: naive
...
class Car:
    ...
    def __init__(self, id, state_of_charge, target_range, hours_to_departure, consumption_per_km, is_priority,
